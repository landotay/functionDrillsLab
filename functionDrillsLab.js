...
function theEliminator(str1, str2) {
...
let competition = theEliminator(contestants, loser)
...
// let sampleString = "Hi, my name is Kylo."
// let fart = 'damn'
// const namePasser = (str) =>{
//   str = console.log(`${str.toUpperCase()}`)
// }

// console.log(namePasser(fart))
...
const emailCheck = (email) =>{
 ...
 console.log(emailCheck(' Landon.B.Taylor@gmail.com'))
...
// const frogBuyer2 = (gold) =>{
//   return Math.floor(gold / 3)

// }

// let totalFrogs2 = frogBuyer2(17)
